...
*__NOTE__: The package is stable and fully functional but is no longer
under active development. Updates and support will be provided on a
best-effort basis.*

*__Recommendation__: Users looking for more advanced features and expanded capabilities are encouraged to explore the [microEDA](https://github.com/jrotzetter/microEDA) package.*
